...
export default function BotaoWhatsApp({ produto }: BotaoWhatsAppProps) {
  ...
  const imagemAtual = useMemo(() => {
    ...
    // Primeiro tenta achar imagem com a cor exata
    ...
    // Se não achar, tenta pelo alt_text
    ...
    // Se não achar nada, usa a primeira imagem
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            {produto.cores.map((cor) => {
              ...
              // Verificar se tem imagem para essa cor
