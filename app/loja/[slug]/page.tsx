  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-8">
        <Link href="/" className="hover:text-pink-600 transition-colors">Início</Link>
        <span className="mx-2">/</span>
        <Link href="/loja" className="hover:text-pink-600 transition-colors">Loja</Link>
        {produto.categorias && (
          <>
            <span className="mx-2">/</span>
            <Link href={`/loja?categoria=${produto.categorias.slug}`} className="hover:text-pink-600 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          ...
          {/* ⚠️ APENAS o BotaoWhatsApp - ele já tem tamanho, cor e quantidade */}
